...
ActiveRecord::Schema.define(version: 20130709231032) do
  ...
  create_table "dev_skills", force: true do |t|
  ...
  add_index "skills", ["area_id"], name: "index_skills_on_area_id", using: :btree
